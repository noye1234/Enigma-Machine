...
public class EnigmaRotor implements Serializable {
    ...
    public int getDistanceFromWindow() {
        return distanceFromWindow;
    }
    ...
    public String toStringWithoutChar() {
        StringBuilder result = new StringBuilder();
        result.append(this.startingPosition).append(this.distanceFromWindow);
        return result.toString();
    }
    ...
    public String getWiringAsString() {
        StringBuilder wiring = new StringBuilder();
        for (RotorMapping mapping : mappings) {
            wiring.append(mapping.getInputChar()).append(":").append(mapping.getOutputChar()).append(";");
        }
